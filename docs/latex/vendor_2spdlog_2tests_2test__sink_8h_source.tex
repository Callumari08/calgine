...
\hypertarget{vendor_2spdlog_2tests_2test__sink_8h_source}{}\label{vendor_2spdlog_2tests_2test__sink_8h_source}\index{src/vendor/spdlog/tests/test\_sink.h@{src/vendor/spdlog/tests/test\_sink.h}}
\mbox{\hyperlink{vendor_2spdlog_2tests_2test__sink_8h}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{00019\ \textcolor{keyword}{class\ }\mbox{\hyperlink{classspdlog_1_1sinks_1_1test__sink}{test\_sink}}\ :\ \textcolor{keyword}{public}\ \mbox{\hyperlink{classspdlog_1_1sinks_1_1base__sink}{base\_sink}}<Mutex>\ \{}
...
\DoxyCodeLine{00041\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{classspdlog_1_1sinks_1_1test__sink_a65be91d89b23ab33ce9af38ac97a65a0}{lines\_}};}
\DoxyCodeLine{00042\ \ \ \ \ \}}
\DoxyCodeLine{00043\ }
...
\DoxyCodeLine{00046\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{namespacespdlog_a6a10a737c7e1471c8491ae251e06cff5}{memory\_buf\_t}}\ formatted;}
\DoxyCodeLine{00047\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classspdlog_1_1sinks_1_1base__sink_ae4a534f4ac712f4d73a15937fc83bc73}{base\_sink<Mutex>::formatter\_}}-\/>format(msg,\ formatted);}
...
\DoxyCodeLine{00051\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (\mbox{\hyperlink{classspdlog_1_1sinks_1_1test__sink_a65be91d89b23ab33ce9af38ac97a65a0}{lines\_}}.size()\ <\ lines\_to\_save)\ \{}
\DoxyCodeLine{00052\ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classspdlog_1_1sinks_1_1test__sink_a65be91d89b23ab33ce9af38ac97a65a0}{lines\_}}.emplace\_back(formatted.begin(),\ formatted.end()\ -\/\ \textcolor{keyword}{static\_cast<}diff\_t\textcolor{keyword}{>}(eol\_len));}
\DoxyCodeLine{00053\ \ \ \ \ \ \ \ \ \}}
...
\DoxyCodeLine{00063\ \ \ \ \ std::vector<std::string>\ \mbox{\hyperlink{classspdlog_1_1sinks_1_1test__sink_a65be91d89b23ab33ce9af38ac97a65a0}{lines\_}};}
\DoxyCodeLine{00064\ \};}
\DoxyCodeLine{00065\ }
\DoxyCodeLine{00066\ \textcolor{keyword}{using\ }\mbox{\hyperlink{namespacespdlog_1_1sinks_a12e0507953ac6ceb77d264323a891e22}{test\_sink\_mt}}\ =\ \mbox{\hyperlink{classspdlog_1_1sinks_1_1test__sink}{test\_sink<std::mutex>}};}
\DoxyCodeLine{00067\ \textcolor{keyword}{using\ }\mbox{\hyperlink{namespacespdlog_1_1sinks_ad0a497f6ad9d3f5193c1fe94490faf32}{test\_sink\_st}}\ =\ \mbox{\hyperlink{classspdlog_1_1sinks_1_1test__sink}{test\_sink<details::null\_mutex>}};}
\DoxyCodeLine{00068\ }
