...
\hypertarget{vendor_2spdlog_2include_2spdlog_2async__logger_8h_source}{}\label{vendor_2spdlog_2include_2spdlog_2async__logger_8h_source}\index{src/vendor/spdlog/include/spdlog/async\_logger.h@{src/vendor/spdlog/include/spdlog/async\_logger.h}}
\mbox{\hyperlink{vendor_2spdlog_2include_2spdlog_2async__logger_8h}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{00031\ \}}
\DoxyCodeLine{00032\ }
\DoxyCodeLine{00033\ \textcolor{keyword}{class\ }\mbox{\hyperlink{calgine_2vendor_2include_2spdlog_2common_8h_a52ddbd25f1bb074a1b09e10a3e5b177d}{SPDLOG\_API}}\ \mbox{\hyperlink{classspdlog_1_1async__logger}{async\_logger}}\ final\ :\ \textcolor{keyword}{public}\ std::enable\_shared\_from\_this<async\_logger>,}
\DoxyCodeLine{00034\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{public}\ \mbox{\hyperlink{classspdlog_1_1logger}{logger}}\ \{}
...
\DoxyCodeLine{00047\ }
\DoxyCodeLine{00048\ \ \ \ \ \mbox{\hyperlink{classspdlog_1_1async__logger_ad42c05a733917cc7e7b3d9d2ad10a47f}{async\_logger}}(std::string\ logger\_name,}
\DoxyCodeLine{00049\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{namespacespdlog_a6b41f59bab8dee405a345cd5d3dd64c9}{sinks\_init\_list}}\ sinks\_list,}
...
\DoxyCodeLine{00052\ }
\DoxyCodeLine{00053\ \ \ \ \ \mbox{\hyperlink{classspdlog_1_1async__logger_a99dcf454b74db04fe3300c68baff4d79}{async\_logger}}(std::string\ logger\_name,}
\DoxyCodeLine{00054\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{namespacespdlog_af2c8ef75fdf4b851e8bd5d2e417da8e0}{sink\_ptr}}\ single\_sink,}
...
\DoxyCodeLine{00057\ }
\DoxyCodeLine{00058\ \ \ \ \ std::shared\_ptr<logger>\ \mbox{\hyperlink{classspdlog_1_1async__logger_af001b8b03a64e57fac1e8e0ddf107317}{clone}}(std::string\ new\_name)\ \textcolor{keyword}{override};}
\DoxyCodeLine{00059\ }
\DoxyCodeLine{00060\ \textcolor{keyword}{protected}:}
\DoxyCodeLine{00061\ \ \ \ \ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{classspdlog_1_1async__logger_aae909dd6f11e60deba30891072c277f7}{sink\_it\_}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{structspdlog_1_1details_1_1log__msg}{details::log\_msg}}\ \&msg)\ \textcolor{keyword}{override};}
\DoxyCodeLine{00062\ \ \ \ \ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{classspdlog_1_1async__logger_ae7eeca32af4d650bc1e2dd06122d0224}{flush\_}}()\ \textcolor{keyword}{override};}
\DoxyCodeLine{00063\ \ \ \ \ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{classspdlog_1_1async__logger_a91e69c0edab9a7510f01d76a831b72dd}{backend\_sink\_it\_}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{structspdlog_1_1details_1_1log__msg}{details::log\_msg}}\ \&incoming\_log\_msg);}
\DoxyCodeLine{00064\ \ \ \ \ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{classspdlog_1_1async__logger_a24a37552c3339c7b129a38a2c4702689}{backend\_flush\_}}();}
\DoxyCodeLine{00065\ }
...
\DoxyCodeLine{00073\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{vendor_2spdlog_2include_2spdlog_2async__logger-inl_8h}{async\_logger-\/inl.h}}"{}}}
